...
class Giropay {
  ...
  getEpsBanks() {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_this.config.httpClient, `${_this.config.host}/giropay/eps/banks`, _this.config, _this.config.sk);
  ...
  getBanks() {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_this2.config.httpClient, `${_this2.config.host}/giropay/banks`, _this2.config, _this2.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
...
//# sourceMappingURL=giropay.js.map